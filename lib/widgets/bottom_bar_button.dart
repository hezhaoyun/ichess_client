...
class BottomBarButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final labelFontSize =
        Theme.of(context).platform == TargetPlatform.iOS ? 11.0 : Theme.of(context).textTheme.bodySmall?.fontSize;
              ...
              children: [
                if (blink)
                  _BlinkIcon(
                    ...
                    icon: icon,
                    color: highlighted ? primary : Theme.of(context).iconTheme.color ?? Colors.black,
                  )
                else
                  Badge(
